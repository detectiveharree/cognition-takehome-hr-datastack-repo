...
| `currency`      | string  | Currency of the returned prices (reflects the `currency` query parameter) |
| `adjusted`      | boolean | Whether split-adjusted data was requested      |
| `splitAdjustmentFactor` | number | Split adjustment factor applied to prices (1.0 = no adjustment) |
